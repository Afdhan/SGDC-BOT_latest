...
let handler = async(m, { conn, text }) => {
	if (!text) return conn.reply(m.chat, 'Masukkan nama mobil!', m)
	  await m.reply('*[ WAIT ]* _Sedang Diproses..._')
	axios.get(`https://api.vhtear.com/infomobil?merk=${text}&apikey=NOT-PREMIUM`)
        .then((res) => {
