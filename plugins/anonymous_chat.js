...
async function handler(m, { command, usedPrefix }) {
    ...
    switch (command) {
        ...
        case 'leave': {
            ...
            if (other) this.sendMessage(other, `Partner Anda Meninggalkan Chat!\n\nKetik *${usedPrefix}next* Untuk Melanjutkan`, MessageType.text)
...
handler.command = ['start', 'leave', 'next', 'anonymo?uschat']
